define(['angularAMD'], function (angularAMD) {
    ...
    angularAMD.factory('keyshortcut', ['$window', '$timeout', function ($window, $timeout) {
        ...
        // when keydown a return a
        keyboardManagerService.input = function(callback,opt){
            var fct, elt, code, k;
            ...
            fct = function (e) {
                ...
                if (code == 189) character = "-";
                if (code == 190) character = "."; 
                if (code == 222) character = "'";
